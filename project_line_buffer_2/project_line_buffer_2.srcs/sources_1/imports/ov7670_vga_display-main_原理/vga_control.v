    ...
    if (!reset) begin
        ...
        if (hcount < 320 && vcount < 240) begin
            if (testmode) begin
                ...
                vga_red_reg[3:0] <= #1 (77*ram_output_data[11:8]+150*ram_output_data[7:4]+ram_output_data[3:0])>>8;
                vga_green_reg[3:0] <= #1 (77*ram_output_data[11:8]+150*ram_output_data[7:4]+ram_output_data[3:0])>>8;
                vga_blue_reg[3:0] <= #1 (77*ram_output_data[11:8]+150*ram_output_data[7:4]+ram_output_data[3:0])>>8;
            // end
