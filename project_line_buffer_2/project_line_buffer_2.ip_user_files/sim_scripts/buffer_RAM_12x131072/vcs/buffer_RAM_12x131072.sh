...
#
# Script generated by Vivado on Thu Dec 28 18:15:54 +0800 2023
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : buffer_RAM_12x131072.sh
...
#
# Usage        : buffer_RAM_12x131072.sh
#                buffer_RAM_12x131072.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                buffer_RAM_12x131072.sh [-reset_run]
#                buffer_RAM_12x131072.sh [-reset_log]
#                buffer_RAM_12x131072.sh [-help]
#
...
#                script (type 'buffer_RAM_12x131072.sh -help' for more information).
#
...
# script info
echo -e "buffer_RAM_12x131072.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./buffer_RAM_12x131072.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.buffer_RAM_12x131072 xil_defaultlib.glbl -o buffer_RAM_12x131072_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./buffer_RAM_12x131072_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key buffer_RAM_12x131072_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc buffer_RAM_12x131072_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./buffer_RAM_12x131072.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: buffer_RAM_12x131072.sh [-help]\n\
Usage: buffer_RAM_12x131072.sh [-step]\n\
Usage: buffer_RAM_12x131072.sh [-lib_map_path]\n\
Usage: buffer_RAM_12x131072.sh [-reset_run]\n\
Usage: buffer_RAM_12x131072.sh [-reset_log]\n\
Usage: buffer_RAM_12x131072.sh [-keep_index]\n\
Usage: buffer_RAM_12x131072.sh [-noclean_files]\n\n\
