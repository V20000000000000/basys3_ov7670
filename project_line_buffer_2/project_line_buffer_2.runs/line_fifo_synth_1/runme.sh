...
HD_PWD='D:/verilog_practice/project_line_buffer_2/project_line_buffer_2.runs/line_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log line_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source line_fifo.tcl
