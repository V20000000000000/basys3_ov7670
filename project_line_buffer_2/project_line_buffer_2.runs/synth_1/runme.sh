...
HD_PWD='D:/verilog_practice/project_line_buffer_2/project_line_buffer_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_vga_display_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source camera_vga_display_top.tcl
