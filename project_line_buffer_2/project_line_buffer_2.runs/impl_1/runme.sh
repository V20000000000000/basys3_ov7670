...
HD_PWD='D:/verilog_practice/project_line_buffer_2/project_line_buffer_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_vga_display_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source camera_vga_display_top.tcl -notrace
