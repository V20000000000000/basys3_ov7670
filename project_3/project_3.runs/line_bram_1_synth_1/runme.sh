...
HD_PWD='D:/verilog_practice/project_3/project_3.runs/line_bram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log line_bram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source line_bram_1.tcl
