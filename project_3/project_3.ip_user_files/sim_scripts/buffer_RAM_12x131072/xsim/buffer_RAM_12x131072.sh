...
#
# Script generated by Vivado on Thu Mar 07 22:38:50 +0800 2024
...
# script info
echo -e "buffer_RAM_12x131072.sh - Script generated by export_simulation (Vivado v2023.2.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot buffer_RAM_12x131072 xil_defaultlib.buffer_RAM_12x131072 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim buffer_RAM_12x131072 -key {Behavioral:sim_1:Functional:buffer_RAM_12x131072} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb buffer_RAM_12x131072.wdb xsim.dir libdpi.so)
