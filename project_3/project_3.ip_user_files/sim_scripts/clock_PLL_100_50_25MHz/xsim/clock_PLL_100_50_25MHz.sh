...
#
# Script generated by Vivado on Thu Dec 28 18:14:04 +0800 2023
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clock_PLL_100_50_25MHz.sh
...
#
# Usage        : clock_PLL_100_50_25MHz.sh
#                clock_PLL_100_50_25MHz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clock_PLL_100_50_25MHz.sh [-reset_run]
#                clock_PLL_100_50_25MHz.sh [-reset_log]
#                clock_PLL_100_50_25MHz.sh [-help]
#
...
# script info
echo -e "clock_PLL_100_50_25MHz.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clock_PLL_100_50_25MHz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 32  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clock_PLL_100_50_25MHz xil_defaultlib.clock_PLL_100_50_25MHz xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clock_PLL_100_50_25MHz -key {Behavioral:sim_1:Functional:clock_PLL_100_50_25MHz} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clock_PLL_100_50_25MHz.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clock_PLL_100_50_25MHz.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clock_PLL_100_50_25MHz.sh [-help]\n\
Usage: clock_PLL_100_50_25MHz.sh [-step]\n\
Usage: clock_PLL_100_50_25MHz.sh [-lib_map_path]\n\
Usage: clock_PLL_100_50_25MHz.sh [-reset_run]\n\
Usage: clock_PLL_100_50_25MHz.sh [-reset_log]\n\
Usage: clock_PLL_100_50_25MHz.sh [-keep_index]\n\
Usage: clock_PLL_100_50_25MHz.sh [-noclean_files]\n\n\
