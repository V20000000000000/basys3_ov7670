...
#                script (type 'clock_PLL_100_50_25MHz.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clock_PLL_100_50_25MHz xil_defaultlib.glbl -o clock_PLL_100_50_25MHz_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clock_PLL_100_50_25MHz_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clock_PLL_100_50_25MHz_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clock_PLL_100_50_25MHz_simv.daidir vcs_lib c.obj)
