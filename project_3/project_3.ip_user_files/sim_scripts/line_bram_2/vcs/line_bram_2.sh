...
#
# Script generated by Vivado on Fri Mar 08 19:39:13 +0800 2024
# SW Build 4081461 on Thu Dec 14 12:24:51 MST 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : line_bram_2.sh
...
#
# Usage        : line_bram_2.sh
#                line_bram_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                line_bram_2.sh [-reset_run]
#                line_bram_2.sh [-reset_log]
#                line_bram_2.sh [-help]
#
...
#                script (type 'line_bram_2.sh -help' for more information).
#
...
# script info
echo -e "line_bram_2.sh - Script generated by export_simulation (Vivado v2023.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./line_bram_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.line_bram_2 xil_defaultlib.glbl -o line_bram_2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./line_bram_2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key line_bram_2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc line_bram_2_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./line_bram_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: line_bram_2.sh [-help]\n\
Usage: line_bram_2.sh [-step]\n\
Usage: line_bram_2.sh [-lib_map_path]\n\
Usage: line_bram_2.sh [-reset_run]\n\
Usage: line_bram_2.sh [-reset_log]\n\
Usage: line_bram_2.sh [-keep_index]\n\
Usage: line_bram_2.sh [-noclean_files]\n\n\
