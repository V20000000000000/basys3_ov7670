...
#
# Script generated by Vivado on Fri Mar 08 19:38:45 +0800 2024
# SW Build 4081461 on Thu Dec 14 12:24:51 MST 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : line_bram.sh
...
#
# Usage        : line_bram.sh
#                line_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                line_bram.sh [-reset_run]
#                line_bram.sh [-reset_log]
#                line_bram.sh [-help]
#
...
# script info
echo -e "line_bram.sh - Script generated by export_simulation (Vivado v2023.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./line_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot line_bram xil_defaultlib.line_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim line_bram -key {Behavioral:sim_1:Functional:line_bram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb line_bram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./line_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: line_bram.sh [-help]\n\
Usage: line_bram.sh [-step]\n\
Usage: line_bram.sh [-lib_map_path]\n\
Usage: line_bram.sh [-reset_run]\n\
Usage: line_bram.sh [-reset_log]\n\
Usage: line_bram.sh [-keep_index]\n\
Usage: line_bram.sh [-noclean_files]\n\n\
